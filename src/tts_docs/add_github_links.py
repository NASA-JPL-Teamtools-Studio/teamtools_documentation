...
Usage:
    python add_github_links.py --docs-dir docs --repo-url "https://github.com/NASA-JPL-Teamtools-Studio/teamtools-documentation" --branch main

Options:
    --docs-dir: Path to the docs directory (default: docs)
    --repo-url: URL of the GitHub repository (default: https://github.com/NASA-JPL-Teamtools-Studio/teamtools-documentation)
...
def main():
    ...
    parser.add_argument('--repo-url', default='https://github.com/NASA-JPL-Teamtools-Studio/teamtools-documentation', 
