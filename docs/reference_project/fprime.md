# DemoSat F-Prime Build

At the moment this is mostly aspirational. But we have plans to implement a simple DemoSat F-Prime build in order to better demonstrate how this software can be used in realtime or in testbed operations.
